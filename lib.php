...
/**
 * This plugin is used to access films on demand files
 *
 * @since Moodle 2.0
...
class repository_filmsondemand extends repository {

    public function __construct($repositoryid, $context = SYSCONTEXTID, $options = array()) {
        parent::__construct($repositoryid, $context, $options);
        $this->keyword = optional_param('filmsondemand_keyword', '', PARAM_RAW);
        $this->licensekey = trim(get_config('filmsondemand', 'licensekey'));
        $this->launchUrl  = trim(get_config('filmsondemand', 'launchURl'));
    }
    ...
    public function get_listing($path = '', $page = '') {
        global $COURSE;
        $callbackurl = new moodle_url('/repository/filmsondemand/callback.php', array('repo_id'=>$this->id));
    ...
    public static function type_config_form($mform, $classname = 'repository') {
        ...
        $licensekey = get_config('filmsondemand', 'licensekey');
        $launchURl  = get_config('filmsondemand', 'launchURl');
        ...
        $mform->addElement('text', 'launchURl', get_string('launchURl', 'repository_filmsondemand'), array('value'=>$launchURl,'size' => '500'));
        $mform->setType('launchURl', PARAM_URL);
        $mform->addRule('launchURl', $strrequired, 'required', null, 'client');
        
        $mform->addElement('text', 'licensekey', get_string('licensekey', 'repository_filmsondemand'), array('value'=>$licensekey,'size' => '500'));
